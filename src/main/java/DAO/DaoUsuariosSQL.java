...
public class DaoUsuariosSQL implements DaoUsuarios, Serializable {
    ...
    public boolean updateUsuario(DAOManager dao, Object object) {
        ...
        try{
            ...
            if (object instanceof Cliente cliente){
                ...
                stmt.setString(3, UtilsPass.hash(cliente.getPass()));
            ...
            if (object instanceof Trabajador trabajador){
                ...
                stmt.setString(3, UtilsPass.hash(trabajador.getPass()));
            ...
            if (object instanceof Admin)
                sentencia = "UPDATE Usuario SET " +
                        ...
                        "Pass='"+UtilsPass.hash(((Admin) object).getPass())+"' " +
    ...
    public Object readUser(DAOManager dao, String email, String pass) {
        if (verificaPass(dao, email,pass)){
    ...
    private boolean verificaPass(DAOManager dao, String email, String pass) {
        String sentencia = "Select u.Pass from Usuarios u where u.correo=?;";
        try{
            dao.open();
            PreparedStatement stmt = dao.getConn().prepareStatement(sentencia);
            stmt.setString(1,email);
            ResultSet rs = stmt.executeQuery();
            if(rs.next()) return UtilsPass.verify(rs.getString("Pass"), pass);
