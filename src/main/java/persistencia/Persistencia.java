...
public class Persistencia {
    ...
    public static Properties iniciaProperties(){
        ...
        InputStream input = Persistencia.class.getClassLoader().getResourceAsStream("config.properties");
        try {
            pro.load(input);
        } catch (IOException e) {
    ...
    public static Properties iniciaPropertiesModif() {
        Properties pro = new Properties();
        ...
        try {
            ...
            throw new RuntimeException("No se pudo cargar o crear config.properties", e);
        }
    ...
    public static String recuperaInicioSesionUsuario(Object user) {
        Properties pro = iniciaPropertiesModif();
        String inicioSesion = "";
